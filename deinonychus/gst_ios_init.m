...
//    GST_PLUGIN_STATIC_DECLARE(matroska);
//#endif
//#if defined(GST_IOS_PLUGIN_MATROSKADEMUX) || defined(GST_IOS_PLUGINS_CODECS)
//    GST_PLUGIN_STATIC_REGISTER(matroskademux);
//#endif
//#if defined(GST_IOS_PLUGIN_MATROSKAMUX) || defined(GST_IOS_PLUGINS_CODECS)
//    GST_PLUGIN_STATIC_REGISTER(matroskamux);
//#endif
//#if defined(GST_IOS_PLUGIN_MATROSKAPARSE) || defined(GST_IOS_PLUGINS_CODECS)
//    GST_PLUGIN_STATIC_REGISTER(matroskaparse);
//#endif
//#if defined(GST_IOS_PLUGIN_WEBMMUX) || defined(GST_IOS_PLUGINS_CODECS)
//    GST_PLUGIN_STATIC_REGISTER(webmmux);
//#endif
#if defined(GST_IOS_PLUGIN_SUBPARSE) || defined(GST_IOS_PLUGINS_CODECS)
